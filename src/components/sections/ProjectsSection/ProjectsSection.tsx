...
const resultados = [
  ...
  },
  {
    id: 3,
    stat: '+30%',
    desc: 'Valorização patrimonial comprovada nos projetos',
  },
];
    ...
    <section className={styles.section} id="cases" aria-label="Cases Reais">
      ...
      <div className={styles.container}>
        ...
        <div className={styles.resultados}>
          <p className={styles.resultadosEyebrow}>O que esses projetos geraram</p>
        ...
        <div className={styles.cta}>
          <div className={styles.ctaContent}>
            ...
            <p className={styles.ctaDesc}>
              Vamos conversar sobre como transformar sua visão em um projeto que marca época.
            </p>
          </div>
