        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-xl text-blue-100 leading-relaxed">
              ...
              ideias em realidade. Consultoria gratuita e atendimento
              personalizado para projetos de automação predial e elétricos.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20">
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-white/20 rounded-2xl p-6 text-center">
                  <i className="fas fa-clock text-3xl text-secondary mb-3"></i>
                  <div className="text-lg font-bold">24h</div>
                  <div className="text-sm opacity-90">Tempo resposta</div>
                </div>
                <div className="bg-white/20 rounded-2xl p-6 text-center">
                  <i className="fas fa-user-tie text-3xl text-accent mb-3"></i>
                  <div className="text-lg font-bold">Gratuita</div>
                  <div className="text-sm opacity-90">Consultoria</div>
                </div>
                <div className="bg-white/20 rounded-2xl p-6 text-center">
                  <i className="fas fa-handshake text-3xl text-blue-300 mb-3"></i>
                  <div className="text-lg font-bold">12 anos</div>
                  <div className="text-sm opacity-90">Experiência</div>
                </div>
                <div className="bg-white/20 rounded-2xl p-6 text-center">
                  <i className="fas fa-award text-3xl text-yellow-300 mb-3"></i>
